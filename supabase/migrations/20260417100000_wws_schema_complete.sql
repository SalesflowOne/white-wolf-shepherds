...
('Luna','luna','female','available','premier',4000,2, array['gentle','intuitive','affectionate'],
...
('Atlas','atlas','male','available','preferred',3250,3, array['playful','social','adaptable'],
...
('Nova','nova','female','available','preferred',3250,4, array['curious','smart','spirited'],
...
('Aurora','aurora','female','available','companion',2500,8, array['nurturing','calm','gentle'],
 'Aurora is soft, nurturing, and completely unflappable — the puppy the others fall asleep on. A natural comfort presence.',
