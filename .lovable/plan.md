...
The word "Alumni" only needs to disappear from what owners and admins *see*. Renaming the role enum, table, and storage bucket would require a coordinated Supabase migration plus data backfill, with no user-visible benefit beyond what the label change already accomplishes.
