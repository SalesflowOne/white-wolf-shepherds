    ...
    Tables: {
      ...
      ao_ai_models: {
        Row: {
          ...
          created_at: string
          credit_rounding_method:
            | Database["public"]["Enums"]["ao_rounding_method"]
            | null
      ...
      kb_profiles: {
        Row: {
          ...
          stripe_customer_id: string | null
          subscription_status:
            | Database["public"]["Enums"]["kb_subscription_status"]
            | null
          updated_at: string | null
        }
        Insert: {
    ...
    Views: {
      ...
      kb_stripe_user_subscriptions: {
        Row: {
          ...
          subscription_id: string | null
          subscription_status:
            | Database["public"]["Enums"]["kb_stripe_subscription_status"]
            | null
        }
        Relationships: []
      }
