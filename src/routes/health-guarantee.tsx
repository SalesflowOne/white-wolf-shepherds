      ...
      <div className="bg-gradient-frost pt-28 pb-16 lg:pt-36">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            We stand behind the health of every puppy we place. Our guarantee reflects our
        ...
        <div className="mx-auto max-w-3xl px-6 space-y-12">
          ...
          <div className="rounded-2xl border-2 border-accent/20 bg-card p-8 shadow-card">
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">
              Every puppy comes with a comprehensive health guarantee covering genetic conditions.
              Our health-tested parents reduce the risk of hereditary issues, and we stand behind
              every puppy we place.
            </p>
          ...
          <div className="rounded-2xl bg-card p-8 shadow-card">
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">
              If you are ever unable to keep your dog — for any reason, at any age — we ask that you
              contact us first. We will always take our dogs back. No White Wolf Shepherd will ever
              end up in a shelter.
            </p>
          </div>
          ...
          {/* Vet Protocol */}
          <div className="rounded-2xl bg-card p-8 shadow-card">
            <h2 className="font-display text-xl font-bold text-foreground">Veterinary Protocol</h2>
            <p className="mt-4 text-muted-foreground leading-relaxed">
              Every puppy receives a complete veterinary examination before placement, including
              age-appropriate vaccines, deworming, and microchipping. All health records are
              provided at pickup.
            </p>
            <p className="mt-4 text-sm text-muted-foreground italic">
