        ...
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            {[
              ...
              litter.ready_date ? `Ready ${formatDateOnly(litter.ready_date)}` : null,
            ]
              .filter(Boolean)
              .join(" · ") || "No details set"}
          </p>
...
function LittersAdminTab() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        {litters.map((lit) => {
          const litPups = puppies.filter((p) => p.litter_id === lit.id && p.status !== "parent");
          return (
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    {[
                      ...
                      lit.ready_date ? `Ready ${formatDateOnly(lit.ready_date)}` : null,
